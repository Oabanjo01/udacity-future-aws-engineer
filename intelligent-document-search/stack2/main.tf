...
module "bedrock_kb" {
  ...
  aurora_arn               = "arn:aws:rds:us-west-2:918330138395:cluster:my-aurora-serverless"
  aurora_db_name           = "myapp"
  aurora_endpoint          = "my-aurora-serverless.cluster-cnu4hrshzdc2.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn        = "arn:aws:secretsmanager:us-west-2:918330138395:secret:my-aurora-serverless-OXE6Ya"
  s3_bucket_arn            = "arn:aws:s3:::bedrock-kb-918330138395"
}
